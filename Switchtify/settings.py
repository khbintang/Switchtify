...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "khairul-bintang-switchtify.pbp.cs.ui.ac.id", "10.0.2.2"]
...
WSGI_APPLICATION = 'Switchtify.wsgi.application'
